...
namespace dxvk {
  ...
  public:
    ...
    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE SetAutoGenFilterType(D3DTEXTUREFILTERTYPE FilterType) final {
  ...
  public:
    ...
    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE GetLevelDesc(UINT Level, D3DSURFACE_DESC *pDesc);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE GetSurfaceLevel(UINT Level, IDirect3DSurface9** ppSurfaceLevel);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE LockRect(UINT Level, D3DLOCKED_RECT* pLockedRect, CONST RECT* pRect, DWORD Flags);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE UnlockRect(UINT Level);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE AddDirtyRect(CONST RECT* pDirtyRect);
  ...
  public:
    ...
    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE GetLevelDesc(UINT Level, D3DVOLUME_DESC *pDesc);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE GetVolumeLevel(UINT Level, IDirect3DVolume9** ppSurfaceLevel);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE LockBox(UINT Level, D3DLOCKED_BOX* pLockedBox, CONST D3DBOX* pBox, DWORD Flags);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE UnlockBox(UINT Level);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE AddDirtyBox(CONST D3DBOX* pDirtyBox);
  ...
  public:
    ...
    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE GetCubeMapSurface(D3DCUBEMAP_FACES Face, UINT Level, IDirect3DSurface9** ppSurfaceLevel);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE LockRect(D3DCUBEMAP_FACES Face, UINT Level, D3DLOCKED_RECT* pLockedRect, CONST RECT* pRect, DWORD Flags);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE UnlockRect(D3DCUBEMAP_FACES Face, UINT Level);

    DECLSPEC_NOTHROW HRESULT STDMETHODCALLTYPE AddDirtyRect(D3DCUBEMAP_FACES Face, CONST RECT* pDirtyRect);
