...
namespace dxvk {
  ...
  HRESULT D3D9DeviceEx::SetStateSamplerState(
    ...
    if (unlikely(Type == D3DSAMP_MIPMAPLODBIAS)) {
      ...
      if (unlikely(Value == Fetch4Enabled)) {
        ...
        if (textureSupportsFetch4
          ...
          && state[StateSampler][D3DSAMP_MINFILTER] == D3DTEXF_POINT) {
    ...
    if (unlikely(Type == D3DSAMP_MAGFILTER && (m_fetch4Enabled & (1u << StateSampler)))) {
      ...
      if (Value == D3DTEXF_POINT && state[StateSampler][D3DSAMP_MINFILTER] == D3DTEXF_POINT && textureSupportsFetch4)
        m_fetch4 |=   1u << StateSampler;
      else
        m_fetch4 &= ~(1u << StateSampler);
    }
    ...
    if (unlikely(Type == D3DSAMP_MINFILTER && (m_fetch4Enabled & (1u << StateSampler)))) {
      ...
      if (Value == D3DTEXF_POINT && state[StateSampler][D3DSAMP_MAGFILTER] == D3DTEXF_POINT && textureSupportsFetch4)
        m_fetch4 |=   1u << StateSampler;
      else
        m_fetch4 &= ~(1u << StateSampler);
    }
